...
<x-layout>
    ...
    <div class="category-scroll1 d-flex flex-row gap-4 ">
        @for ($i = 0; $i < 100; $i++)
            @foreach ($categories as $category)
            @php
            $promos=[ "Eksplor koleksi terbaru dari $category hanya di sini!" , "Ngaku fans $category? Lihat yang terbaru yuk!" , "Produk $category terkini yang wajib kamu lihat." , "Bikin harimu makin lengkap bareng $category." , "Baru datang! $category siap bikin kamu tampil beda."
            ];
            @endphp
            <div class="card text-center flex-shrink-0 hover-shadow" style="width: 15rem; height: 13rem;">
            <div class="card-body">

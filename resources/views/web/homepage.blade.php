                    ...
                    <div class="d-flex justify-content-center">
                        <div class="card bg-dark text-white shadow" style="width: 18rem; height: 30rem;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/product/{{ $product['id'] ?? 1 }}" class="btn btn-outline-light btn-sm">Lihat
                                    Detail</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="category-scroll1 d-flex flex-row gap-4 ">
            @for ($i = 0; $i < 100; $i++)
                @foreach ($categories as $category)
                    @php
                        $promos = [
                            "Eksplor koleksi terbaru dari $category hanya di sini!",
                            "Ngaku fans $category? Lihat yang terbaru yuk!",
                            "Produk $category terkini yang wajib kamu lihat.",
                            "Bikin harimu makin lengkap bareng $category.",
                            "Baru datang! $category siap bikin kamu tampil beda."
                        ];
                    @endphp
                    <div class="card text-center flex-shrink-0 hover-shadow" style="width: 15rem; height: 13rem;">
                        <div class="card-body">
                            ...
                            <div class="card h-100 text-center hover-shadow">
                                ...
                                <div class="card-body position-relative">
                                    <div class="card-info">
                                        ...
                                        <img src="{{ $brandLogos[$product['category']] }}" alt="{{ $product['category'] }}"
                                            class="mb-2" style="width: 30px; height: 35px;">
                                        <div class="d-flex justify-content-center ">
                                            <p class="card-text text-danger fs-5 fw-medium ">
                                                Rp{{ number_format($product['price'], 0, ',', '.') }}</p>
                                            @if ($product['discount'] > 0)
                                                <p class="card-text text-success fs-6 fw-medium ms-3">
                                                    {{ $product['discount'] }}%</p>
                                            @endif
                                        </div>
                                    ...
                                    <div class="card-action">
                                        <a href="/product" class="btn btn-outline-primary ">Lihat Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>

                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="review" id="review" rows="3" placeholder="Ceritakan pengalamanmu..." required></textarea>
                        </div>
                        <!-- choise foto -->
                        <div class="mb-3">
            ...
            <div class="card-footer bg-body-secondary">
                <div class="d-flex flex-wrap justify-content-between align-items-center w-100 gap-2">
                    <span class="fw-bold mb-0">
                        Total Pesanan: <span class="text-danger">Rp{{ number_format($order->total_price, 0, ',', '.') }}</span>
                    </span>

                    @if($order->status == 'Selesai')
                    <div class="d-flex gap-2">
                        <button class="btn btn-warning px-3" data-bs-toggle="modal" data-bs-target="#ratingModal">Nilai</button>
